      ...
      <Container>
        ...
        <div className="my-8">
          ...
          <p className="mt-4 text-muted-foreground text-sm">
            Revolutionize the way you approach interviews by combining AI guidance,
            targeted practice, and actionable feedback to secure your dream role.
          </p>
        </div>
        ...
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[420px] drop-shadow-md overflow-hidden relative">
          ...
          <div className="absolute w-80 bottom-4 right-4 px-4 py-3 rounded-md bg-white/90 backdrop-blur-md shadow-lg">
